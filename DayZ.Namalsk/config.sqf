...
dayz_townGenerator = false; // needed for non-chernarus (napf, namalsk) to get the waterholeproxy code to execute
//DayZMod presets
...
dayz_ServerMessages = [
	"Duping, glitching or using any<br />exploit will result in a<br />permanent ban.",
	"No talking in side.",
